!function ($) {
    ...
    function predefineSpeed(e) {
        if ($.type(e.animationSpeed) == "string") {
            switch (e.animationSpeed) {
                case"slow":
                    e.animationSpeed = [75, 700];
                    break;
                case"medium":
                    e.animationSpeed = [50, 500];
                    break;
                case"fast":
                    e.animationSpeed = [25, 250];
                    break;
                case"instant":
                    e.animationSpeed = [0, 0];
                    break
            }
        }
        return e
    ...
    var defaults = {trigger: "click", animation: "fade", angle: [0, 360], animationSpeed: "medium"};
    ...
    $.fn.flyIn = function (e, t, n, r, i, s, o, u) {
        ...
        this.each(function (e) {
            ...
            }).delay(a).animate({opacity: 1, left: t + "px", top: f + "px"}, u.animationSpeed[1]);
    ...
    $.fn.fadeInIcon = function (e, t, n, r, i, s, o, u) {
        ...
        this.each(function (e) {
            ...
            $(this).css({
                ...
                top: f + "px",
                opacity: 0
            }).delay(a).animate({opacity: 1}, u.animationSpeed[1]);
            a += u.animationSpeed[0]
        })
    };
    $.fn.fadeOutIcon = function (e, t) {
        ...
        this.stop(true, true);
        $(this.get().reverse()).each(function () {
            $(this).delay(n).animate({opacity: 0}, 150);
            n += 15
        }).promise().done(function () {
            e.removeClass("active").css("visibility", "hidden").hide();
            t.removeClass("active")
    ...
    $.fn.showIcon = function (e, t) {
        ...
        e.addClass("active").css({"z-index": r});
        n.show().css({position: "absolute", "z-index": "5", padding: "30px"}).centerAround(e);
        ...
        switch (t.animation) {
            case"fade":
                s.fadeInIcon(n, e, u, a, f, l, i, t);
                break;
            case"fly":
                s.flyIn(n, e, u, a, f, l, i, t);
                break
        }
    };
