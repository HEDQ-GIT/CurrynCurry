...
<header class="main-header" id="top">
    <div class="top-banner-container top-banner-container-style">
        <div class="top-banner-bg custom-bg parallax" data-stellar-background-ratio="0.5"
             style="background-position: -30%;"></div>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 wow fadeInLeft" style="visibility: hidden; -webkit-animation-name: none;">
                <div class="banner features-right features-active">
                    <div class="image-container">
                        <div class="banner-image" style="background-image:url('/img/food1.jpg')"
                             alt="Marine Food Banner">
                        </div>
                    </div>
            ...
            <div class="col-lg-5 col-md-6 col-lg-offset-2 wow fadeInRight"
                ...
                <div class="banner features-left">
                    <div class="image-container">
                        <div class="banner-image" style="background-image:url('/img/food2.jpg')"
                             alt="Marine Food Banner"></div>
                    </div>
                </div>
                <!-- /banner -->
            </div>
            ...
            @foreach($dishes as $idx => $dish)
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mix" style="display: inline-block;">
                    <div class="store-item wow fadeInDown"
                        ...
                        <div style="overflow: hidden; height: 45px; font-size: 1em; margin-bottom: 12px;">
                            {{ $dish->description }}
                        </div>
