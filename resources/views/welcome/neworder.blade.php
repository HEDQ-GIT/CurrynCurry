...
//            var t = $("#text_box1");
    ...
    <table cellpadding="0" cellspacing="0" class="gwc_tb2">
        <tr>
            ...
            <td class="tb2_td2"><a href="#"><img src="/img/food3.jpg"/></a></td>
            <td class="tb2_td3"><a href="#">产品标题</a></td>
            <td class="tb1_td4">一件</td>
            <td class="tb1_td5">
                <input class="subbtn" style=" width:20px; height:18px;border:1px solid #ccc;" type="button" value="-" />
                <input class="textbox" name="" type="text" value="1" style=" width:30px; text-align:center; border:1px solid #ccc;" />
                <input class="addbtn" style=" width:20px; height:18px;border:1px solid #ccc;" type="button" value="+" />
            </td>
